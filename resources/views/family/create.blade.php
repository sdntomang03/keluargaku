                ...
                <form method="POST" action="{{ route('family.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                            ...
                            placeholder="Contoh: Keluarga Besar Mashudi" required>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" rows="4"
                            class="border-slate-300 focus:border-blue-500 focus:ring-blue-500 rounded-xl shadow-sm block w-full py-3"
                            placeholder="Tuliskan catatan singkat mengenai silsilah ini...">{{ old('description') }}</textarea>
                    </div>
