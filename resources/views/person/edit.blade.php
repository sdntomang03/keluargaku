<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Edit Data Keturunan: {{ $person->name }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('person.update', [$family->id, $person->id]) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="address" rows="3"
                            class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full"
                            placeholder="Tuliskan alamat lengkap...">{{ old('address', $person->address) }}</textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Biarkan kosong jika tidak ingin mengubah foto saat ini.
                        </p>
                    </div>
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button type="submit"
                            class="bg-amber-600 text-white px-4 py-2 rounded-md font-semibold hover:bg-amber-700 transition">
                            Simpan Perubahan
                        </button>
                    </div>
                </form>
